...
See [Software.md](./Software/software.md) for more info about software and software installation instructions. The software config files are in a different repo ([nordic-split-zmk](https://github.com/NoseFa/nordic-split-zmk))
